...
export function TerminalPage({ hideHeader = false }) {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [!hideHeader && (_jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-6xl font-bold text-text", children: "Terminal" }), _jsx("p", { className: "mt-0.5 text-xl text-muted", children: "Run Cortex CLI commands interactively" })] }), _jsxs("button", { onClick: () => setLines([mkLine('info', 'Terminal cleared'), mkLine('separator', '')]), className: "flex items-center gap-2 rounded-full border-2 border-border-light bg-card px-3 py-2 text-sm font-medium text-text hover:bg-hover transition-colors", children: [_jsx(Trash2, { className: "h-4 w-4 text-muted" }), "Clear"] })] })), _jsxs("div", { className: "flex gap-5 items-start", children: [_jsxs("div", { className: "flex-1 min-w-0 flex flex-col bg-sidebar rounded-[--radius-lg] border border-white/10 shadow-lg overflow-hidden", style: { minHeight: '500px', maxHeight: '75vh' }, onClick: () => inputRef.current?.focus(), children: [_jsxs("div", { className: "flex items-center gap-2 px-4 py-3 border-b border-white/10 bg-black/60", children: [_jsxs("div", { className: "flex gap-1.5", children: [_jsx("span", { className: "h-3 w-3 rounded-full bg-error/70" }), _jsx("span", { className: "h-3 w-3 rounded-full bg-warning/70" }), _jsx("span", { className: "h-3 w-3 rounded-full bg-success/70" })] }), _jsx("div", { className: "flex-1 flex justify-center", children: _jsxs("span", { className: "flex items-center gap-1.5 text-xs text-white/60 font-mono", children: [_jsx(Terminal, { className: "h-3.5 w-3.5" }), "cortex-terminal"] }) })] }), _jsxs("div", { className: "flex-1 overflow-y-auto p-4 space-y-0.5 font-mono text-sm bg-black/80", children: [lines.map((line) => {
